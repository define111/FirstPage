...
<section class="hero-home dark-overlay mb-5"><img src="img/photo/photo-1467987506553-8f3916508521.jpg" alt="" class="bg-image">
  <div class="container py-7">
    <div class="overlay-content text-center text-white">
      <h1 class="display-3 text-serif font-weight-bold text-shadow mb-0">Dieser Bereich steht bald für Sie zur Verfügung.</h1>
    </div>
  </div>
</section>
<section>
  <div class="container">
    <div class="row">
      <div class="col-xl-8 col-lg-10 mx-auto">
        <p class="lead mb-5">Was würden Sie gerne erfahren? Was inspiriert Sie? <a href="/contakt">Schreiben Sie uns eine Nachricht.</a> Ihr Feedback ist uns wichtig.</p>
